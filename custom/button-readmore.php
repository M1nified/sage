...
function add_meta_boxes(){
 ...
 function add_meta_box_readmore($post,$box){
    ...
    <p><label>Text: <input type="text" name="_sage-postmeta-metabox-readmore-text" value="<?php echo isset($stored_meta['_sage-postmeta-metabox-readmore-text']) ? $stored_meta['_sage-postmeta-metabox-readmore-text'][0] : ''; ?>" placeholder="<?php echo get_option( "sage_cstm_btn_readmore_default_text", ""); ?>"></label></p>
    <p><label>Url:  <input type="text" name="_sage-postmeta-metabox-readmore-link" value="<?php echo isset($stored_meta['_sage-postmeta-metabox-readmore-link']) ? $stored_meta['_sage-postmeta-metabox-readmore-link'][0] : ''; ?>"></label></p>
