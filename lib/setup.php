...
function setup() {
  ...
  register_nav_menus([
    ...
    'top_navigation' => __('Top Navigation Bar','sage'),
    'footer_navigation' => __('Footer Navigation Bar','sage')
  ]);
...
function widgets_init() {
  ...
  register_sidebar([
    'name'          => __('Left First', 'sage'),
    'id'            => 'sidebar-left-first',
    'before_widget' => '<div class="widget %1$s %2$s">',
    'after_widget'  => '</div>',
  ...
  register_sidebar([
    'name'          => __('Footer Nav Right', 'sage'),
    'id'            => 'sidebar-footer-nav-right',
    'before_widget' => '<section class="widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>'
  ...
  register_sidebar([
    'name'          => __('Top Navigation Right', 'sage'),
    'id'            => 'nav-top-bar-right',
    'before_widget' => '<section class="widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>'
...
function display_sidebar_left_first(){
  static $display;
  isset($display) || $display = !in_array(true,[
    is_404(),
    is_page_template('template-custom.php'),
  ...
  return apply_filters('sage/display_sidebar_left_first',$display);
}
...
function display_sidebar_top(){
  ...
  return apply_filters('sage/display_sidebar_top',$display);
}
...
function assets() {
  ...
  wp_enqueue_style( 'sage-theme-ie', Assets\asset_path('styles/ie.css'), array( 'sage-theme-ie' ) );
